...
function Datasets() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/dataset/api/v1/upload/all')
        .then(res => {
            ...
            <div className="row">
                ...
                <div className="col-4" style={{marginTop: '2%', backgroundColor: 'white'}}>
                    ...
                    <div className='form-group mt-4'>
                        <label className='form-label mt-3'>Dataset: </label>
                        <select className="form-control" value={dataType} onChange={(evt) => setDataType(evt.target.value)}>
                    ...
                    <button  className='btn btn-info mt-4 mb-4'>
                        <a href='http://localhost:8000/media/covers/wacafi_results_dataset.csv' download  style={{color: 'white', textDecoration:'none'}}> 
                        Download Template</a>
                    </button>
                </div>
            </div>
