...
export const register = (first_name, last_name, middle_name, organization, country, email, username, password, re_password) => async dispatch => {
    const config = {
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    const body = JSON.stringify({ first_name, last_name, middle_name, organization, country, email, username, password, re_password });
